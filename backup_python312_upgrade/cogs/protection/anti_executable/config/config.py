...
DANGEROUS_EXTENSIONS = {
    ...
    "wsf", "wsh", "msc", "msi", "msp", "hta", "cpl", "scf", "lnk",
    "inf", "reg", "ps1", "ps1xml", "ps2", "ps2xml", "psc1", "psc2",
    "msh", "msh1", "msh2", "mshxml", "msh1xml", "msh2xml",
    
    # 其他平台可執行檔案
    "app", "deb", "pkg", "rpm", "dmg", "run", "bin", "command",
    "workflow", "action", "sh", "bash", "zsh", "fish", "csh", "tcsh",
    
    # 危險腳本
    "py", "rb", "pl", "php", "asp", "aspx", "jsp", "jar",
...
STRICT_EXTENSIONS = {
    ...
    # 其他腳本和配置檔案
    "cfg", "conf", "ini", "xml", "json", "yaml", "yml",
...
def get_file_risk_level(filename: str, strict_mode: bool = False) -> str:
    ...
    try:
        ...
        # 高風險檔案
        high_risk = {
            "exe", "com", "scr", "bat", "cmd", "vbs", "js", "msi", "ps1"
        }
        if ext in high_risk:
            return "高"
