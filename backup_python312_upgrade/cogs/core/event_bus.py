...
class Event:
    ...
    batch_key: Optional[str] = None  # 批處理鍵
    retry_count: int = 0
    max_retries: int = 3
...
class EventPersistence(ABC):
    ...
    @abstractmethod
    async def load_events(self, event_type: Optional[str] = None, 
...
# 便捷函數
async def publish_event(event_type: str, data: Optional[Dict[str, Any]] = None, 
