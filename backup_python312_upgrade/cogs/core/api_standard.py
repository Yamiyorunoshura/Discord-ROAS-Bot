...
class APIResponse:
    ...
    @classmethod
    def create_error(cls, error_code: ErrorCode, message=None, details=None, **metadata):
        """創建錯誤響應"""
        error_data = {
...
def api_endpoint(name: str, description: str = "", version: APIVersion = APIVersion.LATEST,
                rate_limit=None):
    """API端點裝飾器"""
...
def validate_parameters(data: Dict[str, Any], rules: Dict[str, Dict[str, Any]]) -> APIResponse:
    """驗證參數"""
    errors = {}
    validated_data = {}
