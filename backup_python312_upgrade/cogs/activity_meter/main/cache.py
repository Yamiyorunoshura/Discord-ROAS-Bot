...
class ActivityCache:
    ...
    def __init__(self, max_size: int = 1000, default_ttl: int = 300):
        ...
        logger.info(f"✅ ActivityCache 初始化成功 (max_size={max_size}, default_ttl={default_ttl})")
    ...
    def get(self, key: str) -> Optional[Any]:
        ...
        Returns:
            Optional[Any]: 緩存值，如果不存在或過期則返回None
        """
    ...
    def clear(self, pattern: str = None):
        ...
        try:
            if pattern is None:
                ...
                logger.info(f"✅ 根據模式 '{pattern}' 清除了 {len(keys_to_delete)} 個緩存")
