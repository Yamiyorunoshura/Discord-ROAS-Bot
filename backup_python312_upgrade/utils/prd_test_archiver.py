...
# 導入PRD測試驗證器
try:
    from utils.prd_test_validator import PRDTestValidator, PRDTestReport, PRDRequirementStatus
except ImportError:
    # 如果相對導入失敗，嘗試直接導入
    from prd_test_validator import PRDTestValidator, PRDTestReport, PRDRequirementStatus
...
async def main():
    ...
    try:
        ...
        print(f"🧠 記憶更新: memory_bank/prd_test_memory.md")
