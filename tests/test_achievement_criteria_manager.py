...
from src.cogs.achievement.panel.achievement_criteria_manager import (
    AchievementCriteriaManager,
)
...
class TestAchievementCriteriaManager:
    ...
    @pytest.mark.asyncio
    async def test_start_criteria_editor_success(
        self, criteria_manager, mock_interaction, sample_achievement
    ):
        """測試成功啟動條件編輯器."""
        # 設置模擬返回
        criteria_manager.achievement_service.get_achievement_by_id.return_value = (
            sample_achievement
        )
        ...
        criteria_manager.achievement_service.get_achievement_by_id.assert_called_once_with(
            1
        )
        mock_interaction.response.send_message.assert_called_once()

    @pytest.mark.asyncio
    async def test_start_criteria_editor_achievement_not_found(
        self, criteria_manager, mock_interaction
    ):
        """測試啟動條件編輯器時成就不存在."""
        # 設置模擬返回
    ...
    @pytest.mark.asyncio
    async def test_start_criteria_editor_error(
        self, criteria_manager, mock_interaction
    ):
        """測試啟動條件編輯器時發生錯誤."""
        # 設置模擬拋出異常
        criteria_manager.achievement_service.get_achievement_by_id.side_effect = (
    ...
    async def test_save_criteria_success(self, criteria_manager, sample_achievement):
        ...
        criteria_manager.achievement_service.update_achievement.assert_called_once_with(
            sample_achievement
        )
    ...
    async def test_save_criteria_error(self, criteria_manager, sample_achievement):
        ...
        # 設置模擬拋出異常
        criteria_manager.achievement_service.update_achievement.side_effect = Exception(
            "Update error"
        )
    ...
    @pytest.mark.asyncio
    async def test_create_criteria_overview_embed(
        self, criteria_manager, sample_achievement
    ):
        """測試創建條件概覽 Embed."""
        # 設置初始狀態
        criteria_manager.current_achievement = sample_achievement
    ...
    @pytest.mark.asyncio
    async def test_create_criteria_overview_embed_no_criteria(
        self, criteria_manager, sample_achievement
    ):
        """測試創建條件概覽 Embed(無條件)."""
        # 設置初始狀態
...
class TestCriteriaEditorView:
    ...
    @pytest.mark.asyncio
    async def test_message_count_criteria_button(
        self, criteria_editor_view, mock_interaction
    ):
        """測試訊息數量條件按鈕."""
        # 執行測試
    ...
    @pytest.mark.asyncio
    async def test_keyword_criteria_button(
        self, criteria_editor_view, mock_interaction
    ):
        """測試關鍵字條件按鈕."""
        # 執行測試
    ...
    @pytest.mark.asyncio
    async def test_complex_criteria_button(
        self, criteria_editor_view, mock_interaction
    ):
        """測試複合條件按鈕."""
        # 執行測試
    ...
    @pytest.mark.asyncio
    async def test_preview_and_save_button(
        self, criteria_editor_view, mock_interaction
    ):
        """測試預覽並保存按鈕."""
        # 執行測試
...
class TestMessageCountCriteriaModal:
    ...
    def message_count_modal(self, criteria_manager):
        """創建訊息數量條件模態框."""
        from src.cogs.achievement.panel.achievement_criteria_manager import (
            MessageCountCriteriaModal,
        )

        return MessageCountCriteriaModal(criteria_manager)

    @pytest.mark.asyncio
    async def test_on_submit_valid_input(
        self, message_count_modal, mock_interaction, criteria_manager
    ):
        """測試提交有效輸入."""
        # 設置模擬輸入
...
class TestKeywordCriteriaModal:
    ...
    @pytest.mark.asyncio
    async def test_on_submit_valid_input(
        self, keyword_modal, mock_interaction, criteria_manager
    ):
        """測試提交有效輸入."""
        # 設置模擬輸入
...
class TestTimeCriteriaModal:
    ...
    @pytest.mark.asyncio
    async def test_on_submit_valid_input(
        self, time_modal, mock_interaction, criteria_manager
    ):
        """測試提交有效輸入."""
        # 設置模擬輸入
