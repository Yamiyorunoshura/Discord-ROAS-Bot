...
class TestRealAdminService:
    ...
    @pytest.mark.asyncio
    async def test_get_user_achievements_success(self, admin_service, mock_repository, sample_user_achievement):
        """測試成功獲取用戶成就."""
        # 設置模擬返回
    ...
    @pytest.mark.asyncio
    async def test_get_user_progress_success(self, admin_service, mock_repository, sample_progress):
        """測試成功獲取用戶進度."""
        # 設置模擬返回
    ...
    @pytest.mark.asyncio
    async def test_get_user_stats_success(self, admin_service, mock_repository, sample_user_achievement, sample_progress):
        """測試成功獲取用戶統計."""
    ...
    @pytest.mark.asyncio
    async def test_reset_user_achievements_success(self, admin_service, mock_repository):
        """測試成功重置用戶成就."""
        # 設置模擬返回
    ...
    async def test_reset_user_achievements_error(self, admin_service, mock_repository):
        """測試重置用戶成就時發生錯誤."""
        # 設置模擬拋出異常
        mock_repository.delete_user_achievements.side_effect = Exception("Database error")
    ...
    @pytest.mark.asyncio
    async def test_update_user_progress_existing(self, admin_service, mock_repository, sample_progress):
        """測試更新現有進度."""
        # 設置模擬返回
    ...
    @pytest.mark.asyncio
    async def test_update_user_progress_new(self, admin_service, mock_repository, sample_achievement):
        """測試創建新進度記錄."""
        # 設置模擬返回
    ...
    @pytest.mark.asyncio
    async def test_get_achievement_usage_stats_success(self, admin_service, mock_repository, sample_achievement):
        """測試成功獲取成就使用統計."""
        # 設置模擬返回
        mock_repository.get_achievement_by_id.return_value = sample_achievement
