...
from src.cogs.activity_meter.main.activity_module import (
    ActivityAPIError,
    ActivityData,
    ActivityModule,
    UserNotFoundError,
...
class TestActivityModule:
    ...
    def activity_module(self):
        ...
        with (
            patch(
                "src.cogs.activity_meter.main.activity_module.LogicAPIs"
            ) as mock_logic_apis,
            patch(
                "src.cogs.activity_meter.main.activity_module.ActivityCache"
            ) as mock_cache,
            patch(
                "src.cogs.activity_meter.main.activity_module.ActivityCalculator"
            ) as mock_calculator,
            patch(
                "src.cogs.activity_meter.main.activity_module.ActivityRenderer"
            ) as mock_renderer,
        ):
