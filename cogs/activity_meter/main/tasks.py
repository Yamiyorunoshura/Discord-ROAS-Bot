...
class ActivityTasks:
    ...
    async def _process_guild_report(self, guild_id: int, channel_id: int, ymd: str, ym: str, days: int):
        """
        處理單一伺服器的排行榜播報
    ...
    def _create_ranking_embed(self, guild: discord.Guild, rankings: List[Dict[str, Any]], 
                             monthly_stats: Dict[int, int], days: int) -> discord.Embed:
        """
        創建排行榜嵌入
