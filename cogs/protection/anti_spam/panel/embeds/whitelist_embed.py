...
async def create_whitelist_embed(cog: "AntiSpam", guild: discord.Guild, whitelist_type: str = "user") -> discord.Embed:
    """
    創建白名單嵌入
...
async def _create_overview_embed(cog: "AntiSpam", guild: discord.Guild) -> discord.Embed:
    ...
    embed.add_field(
        name="👥 用戶白名單",
        value=f"已添加 {len(user_whitelist)} 個用戶",
        inline=True
    )
    
    embed.add_field(
        name="🎭 角色白名單",
        value=f"已添加 {len(role_whitelist)} 個角色",
        inline=True
    )
...
async def _create_user_whitelist_embed(cog: "AntiSpam", guild: discord.Guild) -> discord.Embed:
    """創建用戶白名單嵌入"""
    embed = discord.Embed(
        title="👥 用戶白名單管理",
...
async def _create_role_whitelist_embed(cog: "AntiSpam", guild: discord.Guild) -> discord.Embed:
    """創建角色白名單嵌入"""
    embed = discord.Embed(
        title="🎭 角色白名單管理",
