...
from ..config.config import MAX_CACHED_MESSAGES, MAX_CACHE_TIME
...
class MessageCache:
    ...
    def should_process(self, channel_id: int) -> bool:
        ...
        if channel_id in self._timestamps and current_time - self._timestamps[channel_id] >= MAX_CACHE_TIME:
            return True
