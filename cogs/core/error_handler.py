...
class ErrorHandler:
    ...
    def handle_error(self, interaction_or_ctx: Optional[Union[discord.Interaction, commands.Context]] = None,
...
def create_error_handler(module_name: str, logger: Optional[logging.Logger] = None) -> ErrorHandler:
    """
    創建錯誤處理器的工廠函數
...
def error_handler(module_name: str, error_code: int = 999, user_msg: str = "操作失敗",
                 recovery_strategy: Optional[str] = None, auto_classify: bool = True):
    """
    錯誤處理裝飾器
