...
class VirtualEnvironmentManager:
    ...
    def detect_existing_venv(self) -> Optional[Path]:
        """
        檢測現有的虛擬環境
    ...
    async def create_virtual_env(self, venv_path: Optional[Path] = None) -> Tuple[bool, str]:
        """
        創建虛擬環境
    ...
    def activate_virtual_env(self, venv_path: Optional[Path] = None) -> Tuple[bool, str]:
        """
        激活虛擬環境
    ...
    async def install_requirements(self, requirements_file: Optional[Path] = None) -> Tuple[bool, str]:
        """
        安裝依賴包
    ...
    def _get_pip_command(self) -> Optional[List[str]]:
        """
        獲取 pip 命令
        
        Returns:
            Optional[List[str]]: pip 命令列表
        """
