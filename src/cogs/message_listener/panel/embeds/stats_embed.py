...
async def stats_embed(cog, guild_id: int | None = None) -> discord.Embed:
    ...
    try:
        ...
        if guild_id:
            ...
            total_count = (
                total_messages[0]["count"]
                if total_messages and len(total_messages) > 0
                else 0
            )
            ...
            deleted_count = (
                deleted_messages[0]["count"]
                if deleted_messages and len(deleted_messages) > 0
                else 0
            )
            ...
            guilds_num = (
                guilds_count[0]["count"]
                if guilds_count and len(guilds_count) > 0
                else 0
            )
