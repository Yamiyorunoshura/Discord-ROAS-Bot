...
class OpenAPIGenerator:
    ...
    def __init__(self, title: str = "Discord ROAS Bot API", version: str = "2.0.0"):
        ...
        self.spec: dict[str, Any] = {
            ...
            "servers": [
                {"url": "http://localhost:8080/api/v1", "description": "開發環境"},
                {"url": "https://api.adrbot.dev/v1", "description": "生產環境"},
            ],
            "paths": {},
            "components": {
                "schemas": {},
            ...
            "tags": [
                {"name": "achievements", "description": "成就管理相關操作"},
                {"name": "categories", "description": "成就分類管理"},
                {"name": "user-achievements", "description": "用戶成就操作"},
                {"name": "progress", "description": "成就進度追蹤"},
                {"name": "statistics", "description": "統計和報表"},
                {"name": "leaderboard", "description": "排行榜功能"},
            ],
        }
    ...
    def add_achievement_schemas(self) -> None:
        ...
        self.spec["components"]["schemas"]["Error"] = {
            ...
            "properties": {
                "code": {"type": "integer", "description": "錯誤代碼", "example": 400},
                "message": {
                    "type": "string",
                    "description": "錯誤訊息",
                    "example": "請求參數無效",
        ...
        self.spec["components"]["schemas"]["PaginationMeta"] = {
            "type": "object",
            "properties": {
                "total": {"type": "integer", "description": "總記錄數", "example": 100},
                ...
                "pages": {"type": "integer", "description": "總頁數", "example": 5},
            },
        }
    ...
    def add_achievement_paths(self) -> None:
        ...
        self.spec["paths"]["/categories/{category_id}"] = {
            ...
            "delete": {
                ...
                "responses": {
                    "204": {"description": "成功刪除分類"},
                    "400": {"description": "分類下還有成就,無法刪除"},
                    "404": {"description": "分類不存在"},
                },
            },
        }
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "description": "篩選特定類型",
                        "required": False,
                        "schema": {"$ref": "#/components/schemas/AchievementType"},
                    },
                    {
                        "name": "active_only",
                        "in": "query",
        ...
        self.spec["paths"]["/users/{user_id}/achievements"] = {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "400": {"description": "用戶已獲得此成就或成就不存在"},
                },
            },
        }
...
def generate_api_documentation(
    ...
    try:
        ...
        result = {
            "success": True,
            "files_generated": [str(json_path), str(html_path), str(report_path)],
